      ...
      <div className="bg-[#5c7eb6] pt-[3%] pb-[3%] bottom-0">
        <div className="flex flex-col lg:flex-row items-center gap-20 font-medium lg:mx-[7%] pb-[3%]">
          <div className="flex-1 ">
            <a href="/">
              <img src="/A2zpassword128x128.png" alt="Logo" />
            </a>
          </div>
          ...
          <div className=" text-white lg:flex-1">
            <ul className="">
              <li className="inline-block">
                <a href="/">
                  <AiFillFacebook size={"2rem"} className="hover:scale-110" />
                </a>
              </li>
              ...
              <li className="inline-block">
                <a href="/">
                  <AiFillLinkedin
                    size={"2rem"}
                    className="hover:scale-110  rounded-xl"
                  />
                </a>
              </li>
            </ul>
        ...
        <div className="border-t-2 border-gray-50">
          <h2 className="text-xl text-white text-center py-[3%] lg:pt-[1%]">
