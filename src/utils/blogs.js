export const blogs = [
  {
    id: "1",
    title:
      "Bitwarden Chrome Extension Vs A2Z offline password manager and generator",
    desc: "The Bitwarden Chrome extension and A2Z offline password manager and generator is a browser extension that allows users to easily manage their passwords and other sensitive information.",
    content: [
      {
        id: 1,
        heading: "",
        desc: `In this world of digitalization, where everything is connected online, it is not possible to
        remember all those passwords. But there are some helpful tools that will help you generate
        and keep your password safe. It will also protect all your information.`,
      },
      {
        id: 2,
        heading: "",
        desc: `To secure your passwords, there are two most popular tools the <a href="https://bitwarden.com/" target="_blank"> Bitwarden Chrome extension </a> and the <a href="https://a2zpassword.net/" target="_blank"> A2Z offline password manager and generator </a> which have been highly used by people for the past few years. While both Bitwarden password generator and A2Z's password manager offer key features, both of them generate and save passwords. In this article, we will talk about them precisely, and you can decide which one to go ahead with. `,
      },
      {
        id: 3,
